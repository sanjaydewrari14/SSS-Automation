...
public class TC_ABMS_centeradmin_Capstone_Assessment_create extends TC_ABMS_BaseClass 
{
	@Test
	public void tc_createBooking() throws InterruptedException, IOException
	{
		try
		{
			...
			Thread.sleep(2000);
			dvr.findElement(By.xpath("//div[@id='s2id_assessment_type']/a")).click();
			Thread.sleep(2000);
			dvr.findElement(By.xpath("//div[text()='Capstone']")).click();
			Thread.sleep(2000);
			...
			String startdate=prop.getProperty("abms_center_capstone_startdate");
			...
			String enddate=prop.getProperty("abms_center_capstone_enddate");
			...
			captureScreenshot("capstone_booking.png");
			dvr.switchTo().defaultContent();
			explicit_wait(By.xpath("//div[@class='fancybox-skin']//a[@title='Close']"), 10);
			dvr.findElement(By.xpath("//div[@class='fancybox-skin']//a[@title='Close']")).click();
			Thread.sleep(5000);
		...
		{
			System.out.println("Error while creating capstone booking");
			captureScreenshot("capstone_booking_err.png");
