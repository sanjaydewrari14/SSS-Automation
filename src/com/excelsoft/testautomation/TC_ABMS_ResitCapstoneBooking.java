...
public class TC_ABMS_ResitCapstoneBooking extends TC_ABMS_BaseClass 
{



	@Test
	public void resitcapstoneBooking() throws IOException
	{
		try
		{
			Thread.sleep(5000);
			...
			captureScreenshot("capstone_resit_booking.png");
			dvr.switchTo().defaultContent();
			explicit_wait(By.xpath("//div[@class='fancybox-skin']//a[@title='Close']"), 10);
			dvr.findElement(By.xpath("//div[@class='fancybox-skin']//a[@title='Close']")).click();
			Thread.sleep(5000);
		...
		{
			System.out.println("Error while creating resit capstone booking");
			captureScreenshot("capstone_resit_booking_err.png");
